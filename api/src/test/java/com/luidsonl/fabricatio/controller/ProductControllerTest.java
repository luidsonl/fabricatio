...
import com.luidsonl.fabricatio.dto.ProductDTO;
import com.luidsonl.fabricatio.dto.ProductRawMaterialDTO;
...
class ProductControllerTest {
        ...
        void testFindAll() throws Exception {
                ProductDTO p1 = ProductDTO.builder().id(1L).code("P001").name("Product 1")
                                .price(new BigDecimal("10.50"))
                                .fractionable(false)
                                .build();
                ProductDTO p2 = ProductDTO.builder().id(2L).code("P002").name("Product 2")
