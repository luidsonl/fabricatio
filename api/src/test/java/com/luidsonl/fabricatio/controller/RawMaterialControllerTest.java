...
class RawMaterialControllerTest {
        ...
        void testFindById() throws Exception {
                RawMaterialDTO dto = RawMaterialDTO.builder().id(1L).code("WATER").name("Water")
                                .unit(MeasureUnitsType.LITER)
                                .build();
        ...
        void testUpdate() throws Exception {
                RawMaterialDTO responseDTO = RawMaterialDTO.builder().id(1L).code("U_SALT").name("Updated Salt")
                                .build();
