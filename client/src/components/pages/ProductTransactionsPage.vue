...
const handleSubmit = async (e: Event) => {
  ...
  formData.value = { productId: 0, quantity: '', type: TransactionType.INVENTORY_IN, note: '' }
  ...
  <MainLayout>
    <div class="p-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-6">
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-slate-800">Product Transactions</h1>
        <Button @click="showForm = true">New Transaction</Button>
      </div>

      <ProductTransactionList />

      <Modal :isOpen="showForm" @close="showForm = false" title="New Product Transaction">
